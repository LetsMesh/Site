...
STATIC_ROOT = os.path.join(BASE_DIR, 'meshapp/static')
...
# Djoser (User Management, Authentication, etc)
...
DJOSER = {
    ...
    'SERIALIZERS': {
        'user_create':'mesh.accounts.serializers.UserCreateSerializer',
        'user': 'mesh.accounts.serializers.UserCreateSerializer',
