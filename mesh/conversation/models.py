...
class Conversation(models.Model):
    ...
    conversation_type = models.SmallIntegerField(choices=ConversationTypes.choices, default=ConversationTypes.DM)
    group_name = models.CharField(max_length=255, blank=True, null=True)

    def __str__(self):
        return f"{self.conversation_type} {self.conversation_type} {self.pk}"
