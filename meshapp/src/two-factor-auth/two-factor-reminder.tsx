...
const TwoFactorAuthReminders = () => {
    ...
    return (
        <body>
            <TwoFactorAuthModal visible={modalVisible} handleOpen={handleModalOpen} handleClose={handleModalClose} />
            <TwoFactorBanner visible={bannerVisible} handleClose={handleBannerClose} />
        </body>
    );
};
